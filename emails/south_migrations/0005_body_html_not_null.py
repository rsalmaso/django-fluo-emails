...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'EmailTemplate.body_html'
        db.alter_column(u'emails_emailtemplate', 'body_html', self.gf('django.db.models.fields.TextField')())

        # Changing field 'EmailTemplateTranslation.body_html'
        db.alter_column(u'emails_emailtemplatetranslation', 'body_html', self.gf('django.db.models.fields.TextField')())

    def backwards(self, orm):

        # Changing field 'EmailTemplate.body_html'
        db.alter_column(u'emails_emailtemplate', 'body_html', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'EmailTemplateTranslation.body_html'
        db.alter_column(u'emails_emailtemplatetranslation', 'body_html', self.gf('django.db.models.fields.TextField')(null=True))
