...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'emails_emailtemplate', 'body_html',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'EmailTemplateTranslation.body_html'
        db.add_column(u'emails_emailtemplatetranslation', 'body_html',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'emails_emailtemplate', 'body_html')

        # Deleting field 'EmailTemplateTranslation.body_html'
        db.delete_column(u'emails_emailtemplatetranslation', 'body_html')
